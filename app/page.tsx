  ...
  return (
    ...
    <div className="px-10 md:px-96 mt-2">
      <div className="border rounded-xl">
        ...
        <div className="p-5">
          ...
          {/* rek2 */}
          <div className="bg-neutral-200 rounded-lg mt-2 flex justify-between items-center px-3">
            <div className="p-2">
              <img src="images/mandiri.png" className="w-32 -mt-5" alt="" />
            ...
            <div className="p-2">
              <img src="images/gift.png" className="w-14 h-auto" alt="" />
            </div>          
          </div>
        </div>
      </div>
    ...
    <div className="px-10 md:px-96">
      ...
      <div className="text-center">
        ...
        <h1>Kedua mempelai dan keluarga</h1>
      </div>
    </div>
    </FadeContent> 
